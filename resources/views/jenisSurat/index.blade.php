                ...
                <div class="card-style mb-30">
                    <div class="header-left d-flex align-items-center justify-content-between mb-4">
                        <div class="menu-toggle-btn mr-15">
                            <a href="{{ route('jenisSurat.create') }}" id="menu-toggle"
                        ...
                        <div class="header-search d-none d-md-flex">
                            <form method="GET" action="{{ route('user') }}">
                                <input name="name" type="text" placeholder="Search..." value="{{ request('email')}}"/>
                    ...
                    <div class="table-wrapper table-responsive">
                        <table class="table">
                            ...
                            @foreach($jenisSurat as $surat)
                                <tr>
                                    <td class="min-width">
                                        <p class="text-capitalize">{{ $surat->name }}</p>
                                    </td>
                                    <td class="min-width">
                                        <p>{{ Str::limit(strip_tags($surat->deskripsi), 30, '...') }}</p>
                                    </td>
                                    <td>
                                    @if($surat->status == 1)
                                        <p>Aktif</p>
                                    ...
                                    @endif
                                        ...
                                        <td>
                                            <div class="action">
                                                <a class="text-success" href="{{ route('jenisSurat.edit', $surat->id) }}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="p-0 pb-1 m-0"> Apakah anda akan mengubah status Jenis Pengajuan Surat ini?</p>
                    <p class="fst-italic modal-keterangan">Status dapat di ubah kembali </p>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        updateModal.addEventListener('show.bs.modal', function (event) {
            ...
            form.action = `/jenisSurat/${suratId}/status`;
        });
    });
</script>
